...
export interface ApiEstadoDePagoEstadoDePago extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pago: Attribute.Boolean;
    metodo_de_pago: Attribute.String;
    mp_alias: Attribute.String;
    mp_status: Attribute.String;
    orden_id: Attribute.Relation<
      'api::estado-de-pago.estado-de-pago',
      'oneToOne',
      'api::orden.orden'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiIngredienteIngrediente extends Schema.CollectionType {
  ...
  attributes: {
    ...
    alerta_de_reposicion: Attribute.Float;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMercadoPagoMercadoPago extends Schema.CollectionType {
  collectionName: 'mercado_pagos';
  info: {
    singularName: 'mercado-pago';
    pluralName: 'mercado-pagos';
...
export interface ApiOrdenOrden extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pedidos: Attribute.Relation<
      ...
      'api::pedido.pedido'
    >;
    estado_de_pago_id: Attribute.Relation<
      'api::orden.orden',
      'oneToOne',
      'api::estado-de-pago.estado-de-pago'
    >;
...
export interface ApiPedidoPedido extends Schema.CollectionType {
  ...
  attributes: {
    ...
    orden_id: Attribute.Relation<
      ...
      'api::orden.orden'
    >;
    producto_id: Attribute.Relation<
      'api::pedido.pedido',
      'oneToOne',
      'api::producto.producto'
    >;
    receta_id: Attribute.Relation<
      'api::pedido.pedido',
      'oneToOne',
      'api::receta.receta'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::estado-de-pago.estado-de-pago': ApiEstadoDePagoEstadoDePago;
      'api::ingrediente.ingrediente': ApiIngredienteIngrediente;
      'api::mercado-pago.mercado-pago': ApiMercadoPagoMercadoPago;
